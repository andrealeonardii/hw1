<?php
        ...
        !empty($_POST["surname"]) && !empty($_POST["confirm_password"]))
    {
        ...
        if (count($error) == 0) {
            ...
            $query = "INSERT INTO Utente(username, password, nome, cognome, email) VALUES('$username', '$password', '$name', '$surname', '$email')";
    ...
    <body>
      <div id="logo" >
        ...
        <section class="main_right">
            <h1>Iscriviti gratuitamente per acquistare pacchetti viaggi</h1>
